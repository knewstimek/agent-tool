...
| **CodeGraph** | tree-sitter(WASM) 기반 AST 코드 인덱싱. 프로젝트를 한 번 인덱싱하면 정의/호출자/피호출자/메서드/상속 구조 쿼리 가능. C/C++, Python, Go, C#, Rust, Java 지원. .gitignore 존중, venv/vendor/third_party 자동 스킵. LLM 호출 없음, 토큰 비용 0 | ✅ |
